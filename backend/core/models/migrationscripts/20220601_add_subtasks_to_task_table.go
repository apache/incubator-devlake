...
type tasks0220601 struct {
	Subtasks json.RawMessage `json:"subtasks"`
}

func (tasks0220601) TableName() string {
	return "_devlake_tasks"
}

type addSubtaskToTaskTable struct{}

func (*addSubtaskToTaskTable) Up(basicRes context.BasicRes) errors.Error {
	return basicRes.GetDal().AutoMigrate(&tasks0220601{})
}
