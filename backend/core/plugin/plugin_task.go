...
type OrchestratedTask struct {
	InitTasks  [][]SubTaskMeta // will be executed in parallel
	CommonTask [][]SubTaskMeta // will be executed in parallel after all InitTasks are finished
	EndTasks   [][]SubTaskMeta // will be executed in parallel after all CommonTask are finished
}
