...
func DeleteWithConnectionId(ctx context.Context, tx dal.Transaction, pluginType string, connectionId uint64) errors.Error {
...
func CreateWithConnectionId(ctx context.Context, tx dal.Transaction, userName, email string, pluginType string, connectionId uint64) (*models.ApiKey, errors.Error) {
	apiKey, hashedApiKey, err := GenerateApiKey(context.Background())
	if err != nil {
		return nil, err
	}
