...
// @Summary get one GitLab repo's latest sync state
// @Description get one GitLab repo's latest sync state
// @Tags plugins/gitlab
...
// @Router /plugins/gitlab/connections/{connectionId}/scopes/{scopeId}/latest-sync-state [GET]
