...
func main() {
	...
	deploymentPattern := cmd.Flags().String("deploymentPattern", "(?i)deploy", "deploy Pattern for project name")
	productionPattern := cmd.Flags().String("productionPattern", "product", "product Pattern for project name")
