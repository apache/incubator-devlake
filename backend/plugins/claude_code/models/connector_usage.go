...
// /v1/organizations/analytics/connectors endpoint.
type ClaudeCodeConnectorUsage struct {
...
func (ClaudeCodeConnectorUsage) TableName() string {
	return "_tool_claude_code_connector_usage"
}
