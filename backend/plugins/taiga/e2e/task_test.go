...
// Taiga tasks: raw API JSON → _tool_taiga_tasks → ticket.Issue (type TASK).
//
...
func TestTaigaTaskDataFlow(t *testing.T) {
	...
	// ── Extraction: raw JSON → _tool_taiga_tasks ─────────────────────────────
	dataflowTester.ImportCsvIntoRawTable(
		"./raw_tables/_raw_taiga_api_tasks.csv",
		"_raw_taiga_api_tasks",
	)

	dataflowTester.FlushTabler(&models.TaigaTask{})
	...
	dataflowTester.VerifyTableWithOptions(models.TaigaTask{}, e2ehelper.TableOptions{
		CSVRelPath:  "./snapshot_tables/_tool_taiga_tasks.csv",
		IgnoreTypes: []interface{}{common.NoPKModel{}},
	})

	// ── Conversion: _tool_taiga_tasks → ticket.Issue / ticket.BoardIssue ─────
	...
	dataflowTester.VerifyTableWithOptions(ticket.Issue{}, e2ehelper.TableOptions{
		CSVRelPath:  "./snapshot_tables/issues_from_tasks.csv",
		IgnoreTypes: []interface{}{common.NoPKModel{}},
	})
	dataflowTester.VerifyTableWithOptions(ticket.BoardIssue{}, e2ehelper.TableOptions{
		CSVRelPath:  "./snapshot_tables/board_issues_from_tasks.csv",
		IgnoreTypes: []interface{}{common.NoPKModel{}},
	})
}
