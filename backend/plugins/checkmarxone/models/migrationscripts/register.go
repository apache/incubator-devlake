...
var _ migrationscripts.MigrationScript = (*InitSchemas)(nil)

type InitSchemas struct{}

func (InitSchemas) Up(basicRes context.BasicRes) errors.Error {
	db := basicRes.GetDal()
	err := db.AutoMigrate(
...
func (InitSchemas) Version() string {
	return "20250101_init_schema"
}
...
func (MigrationScripts) MigrationScripts() []plugin.MigrationScript {
