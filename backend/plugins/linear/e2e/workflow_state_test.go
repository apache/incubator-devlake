...
func TestLinearWorkflowStateDataFlow(t *testing.T) {
	...
	dataflowTester.ImportCsvIntoRawTable("./raw_tables/_raw_linear_workflow_states.csv", "_raw_linear_workflow_states")
	dataflowTester.FlushTabler(&models.LinearWorkflowState{})
	dataflowTester.Subtask(tasks.ExtractWorkflowStatesMeta, taskData)
	dataflowTester.VerifyTableWithOptions(models.LinearWorkflowState{}, e2ehelper.TableOptions{
		CSVRelPath:  "./snapshot_tables/_tool_linear_workflow_states.csv",
