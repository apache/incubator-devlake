...
// @Summary get one Bamboo plan's latest sync state
// @Description get one Bamboo plan's latest sync state
// @Tags plugins/bamboo
...
// @Router /plugins/bamboo/connections/{connectionId}/scopes/{scopeId}/latest-sync-state [GET]
