...
// @Summary get one Jira board's latest sync state
// @Description get one Jira board's latest sync state
// @Tags plugins/jira
...
// @Router /plugins/jira/connections/{connectionId}/scopes/{scopeId}/latest-sync-state [GET]
