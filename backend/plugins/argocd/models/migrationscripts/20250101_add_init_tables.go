...
func (script *addInitTables) Up(basicRes context.BasicRes) errors.Error {
	return migrationhelper.AutoMigrateTables(
		basicRes,
		&archived.ArgocdConnection{},
		&archived.ArgocdApplication{},
		&archived.ArgocdSyncOperation{},
		&archived.ArgocdScopeConfig{},
	)
}

func (script *addInitTables) Version() uint64 {
	return 20250101000001
}

func (script *addInitTables) Name() string {
	return "add init tables for argocd plugin"
}
