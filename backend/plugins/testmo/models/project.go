...
func (p TestmoProject) ScopeId() string {
	return fmt.Sprintf("%d", p.Id)
}

func (p TestmoProject) ScopeName() string {
	return p.Name
}

func (p TestmoProject) ScopeFullName() string {
	return p.Name
}

func (p TestmoProject) ScopeParams() interface{} {
	return &TestmoApiParams{
...
var _ plugin.ToolLayerScope = (*TestmoProject)(nil)
