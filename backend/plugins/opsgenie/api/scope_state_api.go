...
// @Summary get one opsgenie service's latest sync state
// @Description get one opsgenie service's latest sync state
...
// @Router /plugins/opsgenie/connections/{connectionId}/scopes/{scopeId}/latest-sync-state [GET]
