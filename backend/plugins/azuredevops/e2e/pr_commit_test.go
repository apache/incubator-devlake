...
import (
	...
	"github.com/apache/incubator-devlake/plugins/azuredevops/impl"
	"github.com/apache/incubator-devlake/plugins/azuredevops/models"
	"github.com/apache/incubator-devlake/plugins/azuredevops/tasks"
)

func TestAzuredevopsRrCommitDataFlow(t *testing.T) {

	var azuredevops impl.Azuredevops
	dataflowTester := e2ehelper.NewDataFlowTester(t, "azuredevops", azuredevops)
	...
	dataflowTester.ImportCsvIntoRawTable("./raw_tables/_raw_azuredevops_api_pull_requests.csv",
		"_raw_azuredevops_api_pull_requests")
	// verify extraction
	...
	dataflowTester.VerifyTableWithOptions(&models.AzuredevopsPullRequest{}, e2ehelper.TableOptions{
		CSVRelPath:  "./snapshot_tables/_tool_azuredevops_pull_requests_for_pr_commit_test.csv",
		IgnoreTypes: []interface{}{common.NoPKModel{}},
	})

	// import raw data table
	dataflowTester.ImportCsvIntoRawTable("./raw_tables/_raw_azuredevops_api_pull_request_commits.csv",
		"_raw_azuredevops_api_pull_request_commits")
	...
	dataflowTester.VerifyTableWithOptions(models.AzuredevopsCommit{}, e2ehelper.TableOptions{
		CSVRelPath:  "./snapshot_tables/_tool_azuredevops_commits.csv",
		IgnoreTypes: []interface{}{common.NoPKModel{}},
	})
	dataflowTester.VerifyTableWithOptions(models.AzuredevopsRepoCommit{}, e2ehelper.TableOptions{
		CSVRelPath:  "./snapshot_tables/_tool_azuredevops_repo_commits.csv",
		IgnoreTypes: []interface{}{common.NoPKModel{}},
	})

	dataflowTester.VerifyTableWithOptions(models.AzuredevopsPrCommit{}, e2ehelper.TableOptions{
		CSVRelPath:  "./snapshot_tables/_tool_azuredevops_pull_request_commits.csv",
