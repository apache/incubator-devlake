...
func TestAzuredevopsTimelineDataFlow(t *testing.T) {
	...
	dataflowTester.ImportCsvIntoRawTable("./raw_tables/_raw_azuredevops_api_timeline_records.csv", "_raw_azuredevops_api_timeline_records")
	dataflowTester.Subtask(tasks.ExtractApiBuildRecordsMeta, taskData)

	dataflowTester.FlushTabler(&models.AzuredevopsBuild{})
	dataflowTester.ImportCsvIntoRawTable("./raw_tables/_raw_azuredevops_api_builds.csv", "_raw_azuredevops_api_builds")
	...
	dataflowTester.VerifyTable(
		...
		"./snapshot_tables/_tool_azuredevops_timeline_records.csv",
		[]string{
			"connection_id",
			"record_id",
			"build_id",
