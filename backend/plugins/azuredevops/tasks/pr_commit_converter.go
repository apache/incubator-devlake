...
func ConvertApiPullRequestsCommits(taskCtx plugin.SubTaskContext) errors.Error {
	...
	clauses := []dal.Clause{
		...
		dal.Join(`left join _tool_azuredevops_pull_requests
			on _tool_azuredevops_pull_requests.azuredevops_id =
			_tool_azuredevops_pull_request_commits.pull_request_id`),
