...
// @Summary get one sonarqube project's latest sync state
// @Description get one sonarqube project's latest sync state
...
// @Router /plugins/sonarqube/connections/{connectionId}/scopes/{scopeId}/latest-sync-state [GET]
