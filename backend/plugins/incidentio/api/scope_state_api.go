...
// @Summary get one incidentio incident type's latest sync state
// @Description get one incidentio incident type's latest sync state
...
// @Router /plugins/incidentio/connections/{connectionId}/scopes/{scopeId}/latest-sync-state [GET]
