...
func TestGithubDeployment2DataFlow(t *testing.T) {
	...
	dataflowTester.ImportCsvIntoRawTable("./raw_tables/_raw_github_graphql_deployment2.csv", "_raw_github_graphql_deployment")
	...
	dataflowTester.VerifyTableWithOptions(&devops.CicdDeploymentCommit{}, e2ehelper.TableOptions{
		CSVRelPath:  "./snapshot_tables/_tool_github_deployments2.csv",
	...
	dataflowTester.VerifyTableWithOptions(&devops.CicdDeploymentCommit{}, e2ehelper.TableOptions{
		CSVRelPath:  "./snapshot_tables/cicd_deployment_commits2.csv",
		IgnoreTypes: []interface{}{common.NoPKModel{}},
	})

	dataflowTester.VerifyTableWithOptions(&devops.CICDDeployment{}, e2ehelper.TableOptions{
		CSVRelPath:  "./snapshot_tables/cicd_deployments2.csv",
		IgnoreTypes: []interface{}{common.NoPKModel{}},
	})
}
