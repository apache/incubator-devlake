...
func TestGroupScopeDuplicateRows_GroupsConnections(t *testing.T) {
	rows := []scopeDuplicateRow{
		{GithubId: 100, HTMLUrl: "https://github.com/o/a", FullName: "o/a", ConnectionId: 1, ConnectionName: "GitHub Production"},
		{GithubId: 100, HTMLUrl: "https://github.com/o/a", FullName: "o/a", ConnectionId: 2, ConnectionName: "GitHub Staging"},
		{GithubId: 200, HTMLUrl: "https://github.com/o/b", FullName: "o/b", ConnectionId: 3, ConnectionName: "Other"},
	}
	...
	assert.Equal(t, []ScopeDuplicateGroup{
		{
			GithubId: 100,
			HTMLUrl:  "https://github.com/o/a",
			FullName: "o/a",
			Connections: []ScopeDuplicateConnection{
				{ConnectionId: 1, ConnectionName: "GitHub Production"},
				{ConnectionId: 2, ConnectionName: "GitHub Staging"},
			},
		},
		{
			GithubId: 200,
			HTMLUrl:  "https://github.com/o/b",
			FullName: "o/b",
			Connections: []ScopeDuplicateConnection{
...
func TestGroupScopeDuplicateRows_DedupesSameConnection(t *testing.T) {
	rows := []scopeDuplicateRow{
		{GithubId: 100, FullName: "o/a", ConnectionId: 1, ConnectionName: "Prod"},
		{GithubId: 100, FullName: "o/a", ConnectionId: 1, ConnectionName: "Prod"},
	}
...
func TestGroupScopeDuplicateRows_FillsMissingLabels(t *testing.T) {
	rows := []scopeDuplicateRow{
		{GithubId: 100, ConnectionId: 1, ConnectionName: "A"},
		{GithubId: 100, HTMLUrl: "https://github.com/o/a", FullName: "o/a", ConnectionId: 2, ConnectionName: "B"},
	}

	got := groupScopeDuplicateRows(rows)
	assert.Len(t, got, 1)
	assert.Equal(t, "https://github.com/o/a", got[0].HTMLUrl)
