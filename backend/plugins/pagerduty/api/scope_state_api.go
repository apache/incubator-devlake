...
// @Summary get one pagerduty service's latest sync state
// @Description get one pagerduty service's latest sync state
...
// @Router /plugins/pagerduty/connections/{connectionId}/scopes/{scopeId}/latest-sync-state [GET]
