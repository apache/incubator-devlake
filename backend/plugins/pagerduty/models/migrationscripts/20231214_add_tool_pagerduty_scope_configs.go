...
type addPagerDutyScopeConfig20231214 struct{}

func (script *addPagerDutyScopeConfig20231214) Up(basicRes context.BasicRes) errors.Error {
	return basicRes.GetDal().AutoMigrate(&PagerDutyScopeConfig20231214{})
}

func (*addPagerDutyScopeConfig20231214) Version() uint64 {
	return 20231214162000
}

func (script *addPagerDutyScopeConfig20231214) Name() string {
	return "init table _tool_pagerduty_scope_configs"
}
