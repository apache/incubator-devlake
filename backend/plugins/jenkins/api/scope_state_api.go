...
// @Summary get one Jenkins job's latest sync state
// @Description get one Jenkins job's latest sync state
...
// @Router /plugins/jenkins/connections/{connectionId}/scopes/{scopeId}/latest-sync-state [GET]
