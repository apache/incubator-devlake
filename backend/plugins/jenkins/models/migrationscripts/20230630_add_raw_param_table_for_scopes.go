...
func (script *addRawParamTableForScope) Up(basicRes context.BasicRes) errors.Error {
	return basicRes.GetDal().UpdateColumn(archived.JenkinsJob{}.TableName(), "_raw_data_table", "_raw_jenkins_scopes",
		dal.Where("1=1"))
}
...
func (script *addRawParamTableForScope) Name() string {
	return "populated _raw_data_table column for jenkins jobs"
}
