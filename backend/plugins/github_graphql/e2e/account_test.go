...
func TestGithubAccountDataFlow(t *testing.T) {
	...
	dataflowTester.ImportCsvIntoRawTable("./raw_tables/_raw_github_graphql_account.csv", "_raw_github_graphql_accounts")
	dataflowTester.ImportCsvIntoTabler("./raw_tables/_tool_github_repos2.csv", &models.GithubRepo{})

	dataflowTester.Subtask(githubGraphQLTasks.ExtractAccountsMeta, taskData)
	dataflowTester.VerifyTableWithOptions(&models.GithubAccount{}, e2ehelper.TableOptions{
		CSVRelPath:  "./snapshot_tables/_tool_github_accounts.csv",
