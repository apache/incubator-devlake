...
// @Summary get one CircleCI pipeline's latest sync state
// @Description get one CircleCI pipeline's latest sync state
...
// @Router /plugins/circleci/connections/{connectionId}/scopes/{scopeId}/latest-sync-state [GET]
