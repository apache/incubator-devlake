...
// devlake joins it with relative UrlTemplates.
const DefaultEndpoint = "https://api.clickup.com/api/v2/"

// CreateApiClient creates a new rate-limited async API client for ClickUp.
func CreateApiClient(taskCtx plugin.TaskContext, connection *models.ClickUpConnection) (*api.ApiAsyncClient, errors.Error) {
