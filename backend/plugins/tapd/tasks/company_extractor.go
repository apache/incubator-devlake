...
var _ plugin.SubTaskEntryPoint = ExtractCompanies

var ExtractCompanyMeta = plugin.SubTaskMeta{
...
func ExtractCompanies(taskCtx plugin.SubTaskContext) errors.Error {
