...
var _ plugin.SubTaskEntryPoint = CollectCompanies

func CollectCompanies(taskCtx plugin.SubTaskContext) errors.Error {
...
var CollectCompanyMeta = plugin.SubTaskMeta{
