...
// @Summary get one tapd workspace's latest sync state
// @Description get one tapd workspace's latest sync state
// @Tags plugins/tapd
...
// @Router /plugins/tapd/connections/{connectionId}/scopes/{scopeId}/latest-sync-state [GET]
