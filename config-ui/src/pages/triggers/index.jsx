          ...
          {stage === STAGE_FINISHED && (
            <div className='headlineContainer'>
              ...
              <p className='description'>
                Navigate to Grafana to view updated metrics
              </p>
              <AnchorButton
                href={GRAFANA_URL}
                      ...
                      <div className='pluginSpinnerWrap' key={`key-${task.ID}`}>
                        <div key={`progress-${task.ID}`}>
                          ...
                          {task.status === 'TASK_RUNNING' && (
                            <>
                              <Spinner size={12} className='pluginSpinner' />
            ...
            <>
              <div className='headlineContainer'>
                ...
                <p className='page-description'>
                  Run data collection on your plugins
                </p>
              </div>
              ...
              <form className='form'>
                <div className='headlineContainer'>
                  <p className='description'>
                    Create a <strong>http</strong> request to trigger data
                    collect tasks,&nbsp;
                    {/* eslint-disable-next-line max-len */}
                    please customize the following JSON by removing the plugins
                    you don't need and replace with your own&nbsp;
                    {/* eslint-disable-next-line max-len */}
                    <strong>JIRA</strong> <code>boardId</code> /{' '}
                    <strong>GitLab</strong> <code>projectId</code> /{' '}
                    <strong>GitHub</strong> <code>repo</code> and{' '}
                    <code>owner</code> in the request body. &nbsp;
                    {/* eslint-disable-next-line max-len */}
                    For a project with 10k commits and 5k JIRA issues, this can
                    take up to <em>20 minutes</em> for collecting JIRA, GitLab,
                    and Jenkins data.&nbsp;
                    {/* eslint-disable-next-line max-len */}
                    The data collection will take longer for GitHub since they
                    have a rate limit of 2k requests per hour. You can
                    accelerate the process by configuring multiple personal
                    access tokens.
                  </p>
                  ...
                  >
                    ...
                    This is a legacy service and will soon be deprecated in
                    favor of <strong>Pipelines</strong> Feature. See{' '}
                    <a
                ...
                <Button
                  icon='rocket'
                  intent='primary'
                  onClick={(e) => sendTrigger(e)}
                  disable={triggerDisabled}
                >
                  Trigger Collection
                </Button>
              </form>
