...
const PipelineActivity = (props) => {
  ...
  const findActiveStageId = (tasks = []) => {
    ...
    return (
      activeTask?.pipelineRow ||
      completedTask?.pipelineRow ||
      failedTask?.pipelineRow ||
      0
    )
  }
          ...
          <main className='main'>
            <AppCrumbs
              items={[
                ...
                {
                  href: `/pipelines/activity/${pipelineId}`,
                  icon: false,
                  text: 'Pipeline Activity & Details',
                  current: true
                }
              ]}
            />
              ...
              <div style={{ display: 'flex' }}>
                <div>
                    ...
                    >
                      ...
                      <>
                        ...
                        >
                          ...
                          <p>
                            Need Help? &mdash; For better accuracy, ensure that
                            all of your Data Integrations successfully pass the{' '}
                  ...
                  <p className='page-description mb-0'>
                    View the collection stages for a Pipeline Run.
                  </p>
                  <p style={{ margin: '0 0 36px 0', padding: 0 }}>
                    You may <strong>Cancel</strong> a running pipeline before it
                    completes.
                  </p>
                </div>
              </div>
                      ...
                      >
                        ...
                        >
                          ...
                          <div className='pipeline-timestamp'>
                            {dayjs(activePipeline.createdAt).utc().format()}{' '}
                            (UTC)
                          </div>
                          {Object.keys(
                            buildPipelineStages(activePipeline.tasks)
                          ).length > 1 && (
                            <div
                              className='pipeline-multistage-tag'
                        ...
                        >
                          ...
                          >
                            <label style={{ color: Colors.GRAY3 }}>
                              Status
                            </label>
                          ...
                          >
                            ...
                            >
                              {activePipeline.status === 'TASK_RUNNING'
                                ...
                                : activePipeline.finishedAt == null
                                ? 'N/A'
                                : dayjs(activePipeline.finishedAt).from(
                                    activePipeline.beganAt,
                                    true
                                  )}
                            </div>
                          </div>
                          ...
                          >
                            {activePipeline.status === 'TASK_COMPLETED' && (
                              ...
                              >
                                ...
                                <span className='bp3-button-text'>Grafana</span>
                              </a>
                            )}
                            {activePipeline.status === 'TASK_RUNNING' && (
                              <Popover
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      <Button
                                        ...
                                        small
                                        onClick={() =>
                                          cancelPipeline(activePipeline.ID)
                                        }
                                      />
                                    </div>
                                  </div>
                            ...
                            {activePipeline.status === 'TASK_FAILED' && (
                              <Button
                                ...
                                intent='warning'
                                onClick={() =>
                                  restartPipeline(activePipeline.tasks)
                                }
                                disabled={
                                  activePipeline.status !== 'TASK_FAILED'
                                }
                      ...
                      >
                        ...
                        <>
                          ...
                          >
                            ...
                            <p>
                              Monitor <strong>Duration</strong> and{' '}
                              <strong>Progress</strong> completion for all
                              tasks.
                              <strong>Grafana</strong> access will be enabled
                              when the pipeline completes.
                            </p>
                          </div>
                        </>
                      </Popover>
                      {activePipeline.finishedTasks}/{activePipeline.totalTasks}{' '}
                      Tasks Completed
                ...
                >
                  <div style={{ display: 'flex' }}>
                    ...
                    <div>
                      ...
                      <p>
                        Data Provider settings configured for this pipeline
                        execution.
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    {pipelineHasProvider(Providers.JIRA) && (
                      ...
                      >
                        ...
                        <div>
                          ...
                          {activePipeline.tasks
                            .filter((t) => t.plugin === Providers.JIRA)
                            .map((t, tIdx) => (
                              <div key={`board-id-key-${tIdx}`}>
                                ...
                                />
                                <span>
                                  {t.options[Object.keys(t.options)[0]]} on
                                  Server #{t.options[Object.keys(t.options)[1]]}
                                  <br />
                                </span>
                              </div>
                            ))}
                    ...
                    {pipelineHasProvider(Providers.GITHUB) && (
                      ...
                      >
                        ...
                        <div>
                          ...
                          {activePipeline.tasks
                            .filter((t) => t.plugin === Providers.GITHUB)
                            .map((t, tIdx) => (
                                  ...
                                  <>
                                    ...
                                    <ul style={{ fontSize: '9px' }}>
                                      {t.options.tasks.map((oT, otId) => (
                                        <li key={`option-subtask-key${otId}`}>
                                          {oT}
                                        </li>
                                      ))}
                                    </ul>
                    ...
                    {pipelineHasProvider('gitextractor') && (
                      <div
                        className='gitextractor-settings'
                        style={{
                          display: 'flex',
                          paddingLeft: '20px',
                          justifySelf: 'flex-start'
                      ...
                      >
                        ...
                        <div>
                          ...
                          >
                            ...
                            <br />
                            Extract Commits &amp; Refs
                          </label>
                          <div style={{ paddingTop: '15px' }}>
                            {activePipeline.tasks
                              .filter((t) => t.plugin === 'gitextractor')
                              .map((t, tIdx) => (
                              ...
                              .map((t, tIdx) => (
                                <div key={`dbt-opts-key-${tIdx}`}>
                                  ...
                                  <div>
                                    ...
                                    <span>
                                      {JSON.stringify(t.options.projectVars)}
                                    </span>
                                  </div>
                                </div>
                              ))}
            ...
            {!pipelineId && (
              ...
              >
                ...
                >
                  ...
                  <p>
                    Please provide a Pipeline ID to load Run activity and
                    details.
            ...
            >
              ...
              >
                <span>
                  ...
                  to monitor all pipeline activity.
                </span>
                <div>
                  <Button
