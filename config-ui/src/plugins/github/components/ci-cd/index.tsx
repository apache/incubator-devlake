      ...
      >
        ...
        {enable === 1 && (
          <div style={{ paddingLeft: 20 }}>
            <p>
              A GitHub Action job with a name that matches the given regEx will
            ...
            <p>
              A GitHub Action job with a name that matches the given regEx will
              be considered as a job in the Production environment. If you leave
        ...
        <Radio
          label='Not using Jobs in GitHub Action as Deployments'
          value={0}
        />
      </RadioGroup>
    </>
