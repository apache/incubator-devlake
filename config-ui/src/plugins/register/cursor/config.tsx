  ...
  connection: {
    ...
    fields: [
      ...
      'proxy',
      {
        ...
        subLabel:
          'By default, DevLake uses 1,200 requests/hour for Cursor Admin API collection (documented limit is 20 requests/minute). Adjust this value to throttle collection speed.',
        defaultValue: 1200,
      },
    ],
  },
