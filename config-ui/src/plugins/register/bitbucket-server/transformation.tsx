      ...
      {entities.includes('CICD') && (
        <S.CICD>
          ...
          <div className="text">
            ...
            <span>Convert a BitBucket Server Deployment to a DevLake Deployment </span>
            <HelpTooltip content={<img src={ExampleJpg} alt="" width={400} />} />
          </div>
          <div className="text">
            <Checkbox checked={useCustom} onChange={handleChangeUseCustom} />
            <span>Convert a BitBucket Server Pipeline to a DevLake Deployment when its branch/tag name</span>
          </div>
          <div className="sub-text">
            ...
            />
            <span>.</span>
            <HelpTooltip content="View your BitBucket Server Pipelines: https://support.atlassian.com/bitbucket-server/docs/view-your-pipeline/" />
          </div>
          <div className="sub-text">
