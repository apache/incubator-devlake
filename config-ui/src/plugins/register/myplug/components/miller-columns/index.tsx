...
export const MillerColumns = ({ connectionId, selectedItems, onChangeItems }: Props) => {
  ...
  console.log(selectedItems, '__selectedItems');
  console.log(selectedIds, '__selectedIds');
  console.log(items, '__items')

  console.log(items.filter((it) => it.type === 'namespace'), 'jddhjhjd')
  return (
    <>
      <MillerColumnsSelect
        items={items}
        getCanExpand={(it) => it.type === 'namespace'}
