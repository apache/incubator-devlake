...
const RAW_ISSUE_COMMENTS_TABLE = "github_api_issue_comments"

// this struct should be moved to `gitub_api_common.go`

var _ core.SubTaskEntryPoint = CollectApiIssueComments
...
func CollectApiIssueComments(taskCtx core.SubTaskContext) error {
	...
	if since == nil {
		...
		err := db.Model(&latestUpdated).Joins("left join github_repos on github_issue_comments.repo_id = github_repos.github_id").
