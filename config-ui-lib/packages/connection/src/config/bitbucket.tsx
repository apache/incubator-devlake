...
export const BitBucketConfig: IConfig = {
  form: {
    fields: [
      {
        name: 'name',
        label: 'Connection Name',
        render: () => <Input placeholder="eg. Bitbucket" />,
        rule: [{ required: true, message: 'Please input the connection name' }],
      },
      {
        name: 'endpoint',
        label: 'Endpoint URL',
        render: () => <Input placeholder="eg. https://api.bitbucket.com/" />,
        rule: [{ required: true, message: 'Please inpu the endpoint url' }],
      },
      {
        name: 'token',
        label: 'Auth Token',
        render: () => <Input.Password placeholder="eg. 4c5cbdb62c165e2b3d18" />,
